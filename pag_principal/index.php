...
if (isset($_SESSION['rut'])) {
    $query = "SELECT * FROM usuario WHERE rut = '$_SESSION[rut]'";
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item px-1"><a class="nav-link text-white" href=""><b>Inicio</b></a></li>
                    <li class="nav-item px-1"><a class="nav-link text-white" href=""><b>Profesiones</b></a></li>
                    <li class="nav-item px-1"><a class="nav-link text-white" href="#"><b>Servicios</b></a></li>
                </ul>
                <?php
                if (isset($_SESSION['rut'])) {
                    ?>
                    <ul class="navbar-nav mr-auto">
                        <?php if (isset($user['id_rol'])) {
                            if ($user['id_rol'] == 11) { ?>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Login/logout.php"><button type="button" class="btn btn-light">Cerrar Sesión</button></a>
                        </li>
                    </ul>
                    <?php
                } else {
                    ...
                    <div class="row py-3">
                        <div class="col py-5 px-1 mt-4 input-group">
                            <select id="buscador" class="ejemplo" name="filtro_nombreprof" style="width:50%">
                                ...
                                <?php
                                $nombre_profesionales = "SELECT * FROM usuario JOIN profesional USING (nombre_usuario)";
                                $resultado_profesionales = mysqli_query($conexion, $nombre_profesionales);
                                while ($row_profesionales = mysqli_fetch_assoc($resultado_profesionales)) {
                                    $nombre = $row_profesionales["nombres"];
                                    $id = $row_profesionales["nombre_usuario"];
                                    echo "<option value='$id'>$nombre</option>";
                                }
                                ?>
                            </select>
