            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($resultado)){
                    ...
                    echo "<tr>";
                        ...
                        echo"<td><a href='borrar_rs.php?id_e=$id' class='btn btn-danger' style='color: white; text-decoration: none;'>Borrar</a> <a href='form_edicion_rs.php?id_e=$id' class='btn btn-primary' style='color: white; text-decoration: none;'>Editar</a></td>";
                    echo"</tr>";
                }
            ?>
        </table>
