<?php
    ...
    $id_recibido = $_GET["id_e"];
        $consulta = "SELECT * FROM red_soci WHERE id_rs=$id_recibido";
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($resultado)){
                    ...
                    if($id_r == $id){
                        ?>
                        <tr>
                        <td><form action='editar_rs.php' method='POST'>
                         ...
                         <td>
                            <a href= "borrar_rs.php?id_e=<?php echo $id ?>" class="btn btn-danger" style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
                            <a href="form_edicion_rs.php?id_e=<?php echo $id ?>" class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a>
                         </td>
                         </tr>
                        <?php
                    }else{
