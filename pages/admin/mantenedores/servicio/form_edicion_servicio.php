...
<title>Editar servicio - KindomJob's</title>
...
<div class="container-fluid py-2 contenedorcompleto">
    ...
    <table class="table table-striped table-bordered">
        ...
        <tr>
            <td>
                <form action='index.php?p=admin/mantenedores/servicio/editar_servicio' method='POST'>
            ...
            <td>
                <a href="Borrar_servicio.php?id_e=<?php echo $id ?>" class="btn btn-danger"
                    style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
                <a href="form_edicion_servicio.php?id_e=<?php echo $id ?>" class='btn btn-primary'
...
<form action="index.php?p=admin/mantenedores/servicio/ingresar_servicio" method="POST">
