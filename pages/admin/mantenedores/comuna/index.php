    ...
    $(document).on('click', '#edit', function () {
        ...
        fetch("utils/get_provincia.php")
            ...
            .then(data => {
                ...
                // Llenar el select con las provincias
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addComunaModal">
            ...
            <div class="modal-body">
                <form id="addComunaForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_comuna" name="nombre_comuna" placeholder="Ingrese el nombre de la nueva comuna" required>
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-body">
                <form id="editComunaForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nombre_comuna_edit" name="nombre_comuna_edit" placeholder="Ingrese el nombre de la nueva comuna" required>
                    </div>
                    <div class="mb-3">
...
<script>
    $(document).ready(function() {
        const table = $('#comunaTabla').DataTable({
            ...
            "processing": true,
            "ajax": {
                "url": "api/mantenedores/comuna/comunas.php",
                "dataType": "json",
                "type": "POST"
            },
            "columns": [{
    ...
    $(document).on('click', '#delete', function() {
        ...
        Swal.fire({
            title: "¿Estás seguro de querer eliminar esta comuna?",
