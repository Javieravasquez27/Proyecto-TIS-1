...
<title>Editar comuna - KindomJob's</title>
...
<div class="container-fluid py-2 contenedorcompleto">
    ...
    <table class="table table-striped table-bordered ">
        ...
        ?>
        <form action='index.php?p=admin/mantenedores/comuna/editar_comuna' method='POST'>
            <tr>
                <td>
                    <select class="form-select" aria-label="Default select example" name="id_ciudad_e" required>
                        <option value="<?php echo $id_ciudad_consultado ?>">
                            <?php echo $nombre_ciudad_consultado ?>
                        </option>
                        <?php
                ...
                <td>
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="nombre_e" class="form-control" aria-describedby="button-addon2"
                            value="<?php echo $nombre_comuna_consultado ?>" required>
                        <button class="btn btn-outline-success" type="sumbit" id="button-addon">Guardar</button>
                    </div>
        </form>
        </td>
        <td>
            <a href="index.php?p=admin/mantenedores/comuna/borrar_comuna&id_e=<?php echo $id_comuna_consultado ?>" class="btn btn-danger"
                style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
            <a href="index.php?p=admin/mantenedores/comuna/form_edicion_comuna&id_e=<?php echo $id_comuna_consultado ?>" class='btn btn-primary'
