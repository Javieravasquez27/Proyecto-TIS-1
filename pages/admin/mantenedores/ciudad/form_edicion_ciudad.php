        ...
        <table class="table table-striped table-bordered ">
            ...
            while($row = mysqli_fetch_assoc($resultado)){
                ...
                if ($id_recibido == $id) {
                    ...
                    <td>
                        <a href= "borrar_ciudad.php?id_e=<?php echo $id_c ?>" class="btn btn-danger" style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
                        <a href="form_edicion_ciudad.php?id_e=<?php echo $id_c ?>" class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a>
                    </td>
                    </tr>
                <?php
                }else{
                    ...
                    echo "<td>".$ciudad."</td>";
                    echo "<td>";
                        echo "<a href='borrar_ciudad.php?id_e=".$id."' class='btn btn-danger' style='color: white; text-decoration: none;'><span class='material-icons'>delete</span></a>";
                        echo " ";
                        echo "<a href='form_edicion_ciudad.php?id_e=".$id."' class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a>";
                    echo "</td>";
