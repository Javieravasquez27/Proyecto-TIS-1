        ...
        <table class="table table-striped table-bordered">
            ...
            while($row = mysqli_fetch_assoc($resultado)){
                ...
                if ($id_r == $id) {
                    ?>
                    <tr>
                    <td><form action='editar_region.php' method='POST'>
                        <div class="input-group mb-3">
                        <input type="hidden" name="id_e" value="<?php echo $id ?>"> 
                        <input type="text" name="nombre_e" class="form-control" aria-describedby="button-addon2" value="<?php echo $region ?>" style="width:50%" required>
                        <button class="btn btn-outline-success" type="sumbit" id="button-addon">Guardar</button>
                        </div>
                    </form></td>
                    <td>
                        <a href= "borrar_region.php?id_e=<?php echo $id ?>" class="btn btn-danger" style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
                        <a href="form_edicion_region.php?id_e=<?php echo $id ?>" class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a>
                    </td>
                    </tr>
                    <?php
                }else{
