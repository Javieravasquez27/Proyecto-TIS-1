    ...
    <table class="table table-striped table-bordered">
        ...
        while($row=mysqli_fetch_assoc($resultado)){
            ...
            echo "<tr>";
                ...
                echo "<td><a href='index.php?p=admin/mantenedores/rol_permiso/borrar_rol_permiso&id_e=$id' class='btn btn-danger' style='color: white; text-decoration: none;'><span class='material-icons'>delete</span></a></td>";
            echo"</tr>";
        }
    ?>
    </table>
...
<form action="index.php?p=admin/mantenedores/rol_permiso/ingresar_rol_permiso" method="POST">
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header " style="background-color: rgb(234, 228, 246)">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Asignar permisos a rol</h1>
                </div>
