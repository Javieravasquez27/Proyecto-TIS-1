    ...
    <div class="container-fluid contenedorcompleto py-4">
            ...
            <div class="container-fluid mt-2 mb-2">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Institución</a>
                        </li>
                        <li class="nav-item">
        ...
        while($row = mysqli_fetch_assoc($resultado)){
            ...
            echo "<tr>";
                ...
                echo "<td>";
                    echo "<a href='borrar_institucion.php?id_e=".$id_nombre_institucion."' class='btn btn-danger' style='color: white; text-decoration: none;'>Borrar</a>";
                    echo " ";
                    echo "<a href='form_edicion_institucion.php?id_e=".$id_nombre_institucion."' class='btn btn-primary' style='color: white; text-decoration: none;'> Editar</a>";
                echo "</td>";
