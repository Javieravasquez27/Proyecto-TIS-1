        ...
        <div class="row justify-content-sm-center">
            <div class="col-lg-7 col-sm-14 mt-2">
              <div class="d-grid gap-2">
                <a class="btn btn-info rounded-pill" href="mantenedores.php" type="button">Mantenedores</a>
                <a class="btn btn-info rounded-pill" href="../pag_principal/index.php" type="button">Pagina Principal</a>
                <a class="btn btn-info rounded-pill" href="verificaciones.php" type="button">verificaciones</a>
              </div>
            </div>
        </div>
      </div>
