<?php
    ...
    $id_recibido = $_GET["id_e"];
        $consulta = "SELECT * FROM servicio WHERE id_servicio=$id_recibido";
        $resultado = mysqli_query($conexion,$consulta);
        while($row=mysqli_fetch_assoc($resultado)){
            $nombre_consultado = $row["nombre_servicio"];
            $id_r = $row["id_servicio"];
        }
?>
...
<head>
    ...
    <title>Servicios - KindomJob's</title>
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($resultado)){
                    ...
                    if ($id_r == $id) {
                        ?>
                        <tr>
                        <td><form action='editar_servicio.php' method='POST'>
                        ...
                        <td>
                            <a href= "Borrar_servicio.php?id_e=<?php echo $id ?>" class="btn btn-danger" style="color: white; text-decoration: none;"><span class="material-icons">delete</span></a>
                            <a href="form_edicion_servicio.php?id_e=<?php echo $id ?>" class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a>
                        </td>
                        </tr>
                        <?php
                    }else{
                    echo "<tr>";
                        ...
                        echo"<td><a href='Borrar_servicio.php?id_e=$id' class='btn btn-danger' style='color: white; text-decoration: none;'><span class='material-icons'>delete</span></a> <a href='form_edicion_servicio.php?id_e=$id' class='btn btn-primary' style='color: white; text-decoration: none;'><span class='material-icons'>edit</span></a></td>";
                    echo"</tr>";
                }
            }
            ?>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                ...
                <div class="modal-body">
                    <h6>Nombre Del Nuevo Servicio:</h6>
                        <div class="input-group mb-3">
                            <input type="text" name="nombre_e" class="form-control" placeholder="Ingrese el nombre del Nuevo Servicio" aria-label="Recipient's username" aria-describedby="button-addon2" required>
