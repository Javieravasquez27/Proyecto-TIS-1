            ...
            <div class="container-fluid mt-2 mb-2">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#">Tipo Horario</a>
                        </li>
                        <li class="nav-item">
            ...
            <?php
                ...
                while($row=mysqli_fetch_assoc($resultado)){
                    ...
                    echo "<tr>";
                        ...
                        echo"<td><a href='borrar_th.php?id_e=$id' class='btn btn-danger' style='color: white; text-decoration: none;'>Borrar</a> <a href='form_edicion_th.php?id_e=$id' class='btn btn-primary' style='color: white; text-decoration: none;'>Editar</a></td>";
                    echo"</tr>";
                }
            ?>
        </table>
